...
const scrap = async (site, browser) => {
  ...
  for (const word of keyWords) {
    ...
    for (let index = 1; index < pageCount - 1; index++) {
      console.log(`Getting joblinks from https://www.praktischarzt.ch/${word}/?job_category=0&job_location&radius=200/${index}/`);
     ...
     .map((link) => {
      ...
      console.log(`Saving found data from praktischarzt.ch`);
